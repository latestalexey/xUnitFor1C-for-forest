...
Функция ПолучитьСписокИсключений_Справочники_Существующие() Экспорт
	...
	Результат.Добавить("ирАлгоритмы");
	Результат.Добавить("ОбщепитСезоны");
	Результат.Добавить("ХарактеристикиСдельныхНорм");
	Результат.Добавить("СохраненныеНастройки");
	Результат.Добавить("РазрядыТехнологическойОперации");
	Результат.Добавить("ВнешниеПользователи");
	Результат.Добавить("ОбъектыПечати");
...
Функция ПолучитьСписокИсключений_Документы_Новые() Экспорт
	...
	Результат.Добавить("Штрафы");
	Результат.Добавить("НачислениеЗарплатыРаботникамОрганизаций");
...
Функция ПолучитьСписокИсключений_Отчеты() Экспорт
	...
	Результат.Добавить("ОтчетПоДебиторамИКредиторам");
	Результат.Добавить("ПросроченнаяЗадолженностьПокупателей");
...
Функция ПолучитьСписокИсключений_Обработки() Экспорт
	...
	Результат.Добавить("ПолучениеФайловИзИнтернета");
	Результат.Добавить("ЗаполнениеНарядовНаОснованииАктов");
	Результат.Добавить("ОбщиеОбъектыРегламентированнойОтчетности");
	Результат.Добавить("ОбщепитХимикоэнергетическиеПоказатели");
	Результат.Добавить("ОбработкаПодбораНоменклатуры");
	Результат.Добавить("ФормированиеСпискаРаботников");
	Результат.Добавить("КорректировкаДвижений");
	Результат.Добавить("ПодборПродукции");
	Результат.Добавить("РасшифровкаРегламентированнойОтчетности");
	Результат.Добавить("ПодборОстатковПродукции");
